...
public interface IProductCategoryService : IEntityService<ProductCategoryEntity, ProductCategoryCreateDto,
    ProductCategoryUpdateDto,
    Result, bool, bool>
{
    Task<IEnumerable<ProductCategoryDtoForViewer>> GetRecommendationByTag(string tag);
    Task<IEnumerable<ProductCategoryDtoForViewer>> GetRecommendation();
